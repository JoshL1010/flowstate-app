...
HEAD = '''<title>FlowState for Mac</title>
...
.logo-mark{width:22px;height:22px;border-radius:6px;position:relative;flex:none;background:#52B8F2}
.logo-mark::after{content:"";position:absolute;left:4px;top:4px;bottom:4px;width:5px;
